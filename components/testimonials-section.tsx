...
const testimonials = [
  {
    quote:
      "Absolutely addictive! The best kettle corn I've ever had. The perfect balance of sweet and salty.",
    name: "Sarah K.",
    rating: 5,
  },
  {
    quote:
      "The lemonade was so refreshing on a hot day, and the kettle corn? Simply amazing! Honey Run is a must-try.",
    name: "Mike B.",
    rating: 5,
  },
  {
    quote:
      "We hired Honey Run for our company picnic, and it was a huge hit! Everyone loved the fresh kettle corn.",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl font-bold tracking-tighter text-honeyrun-black sm:text-4xl md:text-5xl">
            What Our <span className="text-honeyrun-red-dark">Customers</span>{" "}
            Say
          </h2>
          ...
          {testimonials.map((testimonial) => (
            ...
            >
              <CardHeader className="flex flex-row items-center gap-4 pb-2 pt-6 px-6">
                {" "}
                <div>
                  <h3 className="text-lg font-semibold text-honeyrun-black">
                    {testimonial.name}
                  </h3>
                  <div className="flex">
                    {Array(testimonial.rating)
                      ...
                      .map((_, i) => (
                        <Star
                          key={i}
                          className="h-5 w-5 text-honeyrun-red-dark fill-honeyrun-red-dark"
                        />
                      ))}
                  </div>
                </div>
